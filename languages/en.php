...
return [
	...
	'admin:plugin_settings_transfer:import:options' => 'Import Options',
	'admin:plugin_settings_transfer:import:active' => 'Enable and disable plugins based on the imported "active" status',
	'admin:plugin_settings_transfer:import:priority' => 'Reorder plugins based on imported "priority" values',
	'admin:plugin_settings_transfer:import:settings' => 'Import all plugin settings from the "settings" values',
	'admin:plugin_settings_transfer:import:settings_unset' => 'Unset all plugin settings before import (for plugins listed in the import file)',
	'admin:plugin_settings_transfer:import:invalid_json' => 'Unable to read JSON from uploaded file',
